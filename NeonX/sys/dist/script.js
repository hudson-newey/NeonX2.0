...
function loadBackground() {
    ...
    var backgroundNumber = Math.ceil(Math.random() * backgroundCount);
    var backgroundUrl = "url('./NeonX/backgrounds/" + backgroundNumber + ".png')";
    var backgroundElement = document.getElementById("desktopBG");
